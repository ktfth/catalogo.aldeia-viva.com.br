...
// SEO
useHead({
  title: 'Marketplace de Lojas | Aldeia Viva',
  meta: [
    { name: 'description', content: 'Explore catálogos de produtos de pequenos negócios locais. Compre direto pelo WhatsApp sem taxas.' }
  ]
})
</script>
